...
def trigger(*args, **kwargs):
    ...
    """
    trigger_pipeline(
        'gcs_to_big_query',        # Required: enter the UUID of the pipeline to trigger
        variables={'date_start' : str(kwargs['date_start']), 'date_end' : str(kwargs['date_end'])},           # Optional: runtime variables for the pipeline
